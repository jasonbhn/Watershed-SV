...
cp -r MuscularDystrophy-protein-lincRNA-10k-final-version/ /tmp/ 
...
--genotypes /tmp/MuscularDystrophy-protein-lincRNA-10k-final-version/intermediates/pipeline_input_genotypes.tsv \
--genes /tmp/MuscularDystrophy-protein-lincRNA-10k-final-version/intermediates/genes.bed \
--gene-sv /tmp/MuscularDystrophy-protein-lincRNA-10k-final-version/intermediates/gene_sv.10000.bed \
--annotation-dir /tmp/MuscularDystrophy-protein-lincRNA-10k-final-version/intermediates/ \
--outfile MuscularDystrophy-protein-lincRNA-10k-final-version/combined_annotation_pre_merge_custom_maf.no_control_gene.tmm_corrected.z3.csv \
...
--gene-sv /tmp/MuscularDystrophy-protein-lincRNA-10k-final-version/intermediates/gene_sv.10000.bed \
--annotation-dir /tmp/MuscularDystrophy-protein-lincRNA-10k-final-version/intermediates/ \
--outfile MuscularDystrophy-protein-lincRNA-10k-final-version/combined_annotation_pre_merge_custom_maf_gene_level.no_control_gene.tmm_corrected.z3.csv \
--expressions /tmp/combined_Muscle_top_60PC_RIN_SEX_TMM_TPM.nodup.noGlobalOutliers.zscore.tsv \
--expression-field normalized_resid \
--expression-id-field Ind \
--maf-mode upload \
