...
imputed_data = filter_by_tissue_ind.groupby('Gene').apply(lambda x: impute(x)).reset_index()
imputed_data.to_csv('imputed_correlational_outlier_data.csv',index=False,sep='\t')
